      ...
      <div className="h-screen flex items-center justify-center bg-[url('/greenwave.svg')] bg-cover bg-center lg:bg-fixed font-sans  ">
        <div className="grid grid-cols-2 rounded-lg   h-3/4 ">
          <div
            className={
              view !== "login"
                ? "animate__animated animate__fadeInDown hover:underline hover:decoration-green-500 hover:text-green-500 font-semibold hover:decoration-4 group w-40 h-24 rounded-full hover:border-4 border-transparent hover:border-x-green-500 justify-center items-center flex"
                : "animate__animated animate__fadeInDown underline decoration-green-500 text-green-500 font-semibold decoration-4 group w-40 h-24 rounded-full border-4 border-transparent border-x-green-500 justify-center items-center flex"
            }
